...
class MCQQuestion(Question):
    ...
    answer_order = models.CharField(
        ...
        help_text="Thứ tự các tùy chọn trả lời được hiển thị cho người dùng",
...
class Answer(models.Model):
    question = models.ForeignKey(MCQQuestion, verbose_name='Câu Hỏi', on_delete=models.CASCADE)

    content = models.CharField(max_length=1000,
                               blank=False,
                               help_text="Nhập câu hỏi mà bạn muốn hiển thị",
                               verbose_name="Content")

    correct = models.BooleanField(blank=False,
                                  default=False,
                                  help_text="Đây là câu trả lời đúng",
